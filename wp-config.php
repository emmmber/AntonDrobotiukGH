 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'rput your uniquesadfasdf phrasdafhdcvnse here');
define('SECURE_AUTH_KEY',  'puadsgtsda gsdayourasfasdgsaf dws');
define('LOGGED_IN_KEY',    'put your unique psdgdsvcvhrase here');
define('NONCE_KEY',        'putfgfddgvcx your unixcvnqnue xazcphrase here');
define('AUTH_SALT',        'put qryour unique phraxncvxse here');
define('SECURE_AUTH_SALT', 'putdfs eyouqwr unique pcasdhrase here');
define('LOGGED_IN_SALT',   'put yourqewewrferw utdwgniqufbe phrase here');
define('NONCE_SALT',       'put your uwenique pgerhfgqrase here');
